...
course_name = "IntroPython"

def encryptDecrypt(input):
        key = ['O', 'X', 'N', 'W','A','H','Q','F','Z','U'] #Can be any chars, and any size array
        output = []
...
def google_drive_create_file(gc, fname, email):
    ...
    template.share('alejandro.mesa2@udea.edu.co', perm_type='user', role='writer')
...
def google_drive_create_file_grade_final(gc, sname):
    ...
    grade.share('alejandro.mesa2@udea.edu.co', perm_type='user', role='writer')
...
def fix_sharing():
    ...
    rlxmooc_permision = {
        'type': 'user',
        'role': 'writer',
        'emailAddress': 'alejandro.mesa2@udea.edu.co'
    }
